...
const data = {
    experince: [
        {
            ...
            description: "Over the past six months, I've been dedicated to providing support for ERP systems, troubleshooting network issues, and resolving printer problems. My role involves ensuring smooth operations and addressing technical challenges to maintain an efficient work environment.",
    ...
    education: [
        ...
        },
        {
            ...
            description: "Bachelor's of Science in Information Systems (2019-2023)",
